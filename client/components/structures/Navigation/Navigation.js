      ...
      <div className="container">
        ...
        <div className="nav-left">
          <Link to={auth ? '/home' : '/'} className="nav-item">
            ...
            <figure className="image nav-image1">
                <img className="logo-img"   src='/olx-logo.jpg' alt="" />
              </figure>
        ...
        {auth ? (
          ...
          <Link to="/Submitadd" className="nav-item">
              <button type="button" className="button is-success orange">
                Submit Add
              </button>
            </Link>
            <a className="nav-item is-hoverable" onClick={toggleUserDropdown} onKeyPress={toggleUserDropdown}>
              ...
              {localStorage.setItem('username', user.usernameCase)}
              {user.usernameCase}
